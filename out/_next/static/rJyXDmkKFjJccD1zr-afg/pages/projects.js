  ...
  [12],
  {
    ...
    SpL8: function (e, t, n) {
      ...
      var r = n('q1tI'),
        ...
        c = n('kz3Y'),
        m = a.a.createElement;
      var d = u.default.h3.withConfig({ displayName: 'PageSubTitle', componentId: 'sc-1ugqrvt-0' })(
          ['margin-bottom:', ';font-size:1.25em;'],
          function (e) {
            return e.theme.spacing.medium;
          }
        ),
        p = u.default.img.withConfig({
        ...
        f = u.default.a.withConfig({ displayName: 'ProjectLink', componentId: 'sc-1ugqrvt-2' })([
        ...
        h = u.default.h2.withConfig({ displayName: 'TomatiTitle', componentId: 'sc-1ugqrvt-4' })(
          ['font-size:1.5em;margin:0.5rem 0;a{color:#f93e0b;:hover,:focus{color:', ';}}'],
          Object(l.a)(0.05, '#f93e0b')
        ),
        v = u.default.h2.withConfig({ displayName: 'HuegasmTitle', componentId: 'sc-1ugqrvt-5' })(
          ['font-size:1.5em;margin:0.5rem 0;a{color:#910249;:hover,:focus{color:', ';}}'],
          Object(l.a)(0.05, '#910249')
        ),
        w = u.default.div.withConfig({ displayName: 'PromoImages', componentId: 'sc-1ugqrvt-6' })(
          [
            'margin-top:',
        ...
        b = u.default.img.withConfig({
          displayName: 'PlayStoreIcon',
          componentId: 'sc-1ugqrvt-8',
        })(['width:9.25rem;']),
        C = u.default.img.withConfig({ displayName: 'AppStoreIcon', componentId: 'sc-1ugqrvt-9' })([
          'width:7.5rem;',
        ]),
        ...
        _ = u.default.img.withConfig({ displayName: 'ProjectImg', componentId: 'sc-1ugqrvt-12' })(
          [
      ...
      t.default = function () {
        return m(
          s.a,
          null,
          m(i.a, null, m('title', null, 'Projects - Nidratech')),
          m(c.a, { title: "What we've been up to lately" }),
          m(
            d,
            null,
          ...
          m(
            ...
            m(
              ...
              m(
                f,
                { href: 'https://www.tomati.io', rel: 'noreferrer', target: '_blank' },
                m('img', { src: 'images/tomati-logo.png', title: 'Tomati' })
              ),
              m(
                'div',
                null,
                m(
                  ...
                  m(
                    'a',
                    { href: 'https://www.tomati.io', rel: 'noreferrer', target: '_blank' },
                    m(p, { src: 'images/tomati-logo.png', title: 'Tomati' }),
                    ' Tomati'
                  )
                ),
                m(
            ...
            m(
              w,
              null,
              m(_, { src: 'images/tomati-1.jpg', alt: 'Tomati screenshot #1' }),
              m(_, { src: 'images/tomati-4.jpg', alt: 'Tomati screenshot #2' }),
              m(_, { src: 'images/tomati-2.jpg', alt: 'Tomati screenshot #3' })
            ),
            m(
              I,
              null,
              m(
                ...
                m(b, { src: 'images/android-play-badge.png', title: 'Android app' })
              ),
              m(
                'a',
                {
                ...
                m(C, { src: 'images/app-store-badge.svg', alt: 'iOS app' })
              )
            )
          ),
          m(
            ...
            m(
              ...
              m(
                f,
                { href: 'https://www.huegasm.com', rel: 'noreferrer', target: '_blank' },
                m('img', { src: 'images/huegasm-logo.png', title: 'Huegasm' })
              ),
              m(
                'div',
                null,
                m(
                  ...
                  m(
                    'a',
                    { href: 'https://www.huegasm.com', rel: 'noreferrer', target: '_blank' },
                    m(p, { src: 'images/huegasm-logo.png', title: 'Huegasm' }),
                    ' Huegasm'
                  )
                ),
                m(
            ...
            m(
              w,
              null,
              m(_, { src: 'images/huegasm-1.jpg', alt: 'Huegasm screenshot #1' }),
              m(_, { src: 'images/huegasm-2.jpg', alt: 'Huegasm screenshot #2' }),
              m(_, { src: 'images/huegasm-3.jpg', alt: 'Huegasm screenshot #3' })
            ),
            m(
              I,
              null,
              m(
                ...
                m(y, { src: 'images/chrome-store-badge.png', title: 'Chrome extension' })
              ),
              m(
                'a',
                {
    ...
    Xuae: function (e, t, n) {
      ...
      t.default = function () {
        ...
        return (function (u) {
          ...
          function s(e) {
            var o;
            return r(this, s), (o = l.call(this, e)), d && (t.add(a(o)), n(a(o))), o;
          }
          return (
            o(s, null, [
              {
    ...
    kz3Y: function (e, t, n) {
      ...
      var r = n('q1tI'),
        ...
        i = n('X/xQ'),
        u = a.a.createElement;
      var l = o.default.h1.withConfig({ displayName: 'Title', componentId: 'sc-1dghbrv-0' })([
      ...
      t.a = function (e) {
        var t = e.title;
        return u(s, null, u(l, null, t), u(i.a, null));
      };
    },
    lwAK: function (e, t, n) {
      'use strict';
