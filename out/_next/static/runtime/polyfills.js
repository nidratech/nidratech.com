          ...
          !(function () {
            ...
            var J,
              ...
              dt = function (t, e) {
                ...
                for (; e.length > o; ) b(n, (r = e[o++])) && (~ht(i, r) || i.push(r));
                return i;
              },
              vt = [
                'constructor',
                ...
                from: function (t) {
                  ...
                  if (
                    ...
                    for (i = (o = p.call(u)).next, r = new c(); !(n = i.call(o)).done; h++)
                      (a = l ? Ve(o, f, [n.value, h], !0) : n.value), Ye(r, h, a);
                  return (r.length = h), r;
                },
              }
            );
              ...
              yr = e(function (t) {
                ...
                (t.exports = function (t, r, n, o, i) {
                  ...
                  if (i) a = t;
                    ...
                    if (Xe(u)) {
                      for (c = 0, s = ut(t.length); s > c; c++)
                        if ((f = o ? h(A((p = t[c]))[0], p[1]) : h(t[c])) && f instanceof e)
                          return f;
                      return new e(!1);
                    }
                    a = u.call(t);
                  ...
                  for (l = a.next; !(p = l.call(a)).done; )
                    if ('object' == typeof (f = Ve(a, h, p.value, o)) && f && f instanceof e)
                      return f;
                  return new e(!1);
                }).stop = function (t) {
                  return new e(!0, t);
              ...
              return [
                ...
                function (t, n) {
                  ...
                  for (var d = []; ; ) {
                    ...
                    if (null === v) break;
                    if ((d.push(v), !p)) break;
                    '' === String(v[0]) && (s.lastIndex = si(f, ut(s.lastIndex), h));
                  }
                  for (var g, y = '', m = 0, b = 0; b < d.length; b++) {
                    v = d[b];
                    for (
                      var S = String(v[0]), w = li(pi(it(v.index), f.length), 0), E = [], x = 1;
                      x < v.length;
                      x++
                    )
                  ...
                  [
                    ...
                    function (t, o) {
                      ...
                      for (var p = 0, h = 0, d = []; h < u.length; ) {
                        ...
                        if (null === g || (v = yi(ut(f.lastIndex + (mi ? 0 : h)), u.length)) === p)
                          h = si(u, h, s);
                        else {
            ...
            oc &&
              ...
              (Lu = function () {
                var t = new Nu(),
                  e = Vu(t);
                (this.promise = t), (this.resolve = pc(dc, t, e)), (this.reject = pc(hc, t, e));
              }),
              (Bu.f = tc = function (t) {
