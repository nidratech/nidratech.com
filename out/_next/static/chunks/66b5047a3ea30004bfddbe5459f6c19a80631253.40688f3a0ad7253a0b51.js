    ...
    QmWs: function (t, e, r) {
      ...
      function w(t, e, r) {
        ...
        a &&
          ...
          a[2] || ((c = !1), v.test(a[1]) ? ((l = a[1]), (t = '' + a[3])) : (t = '//' + a[3])),
          (3 !== a[2].length && 1 !== a[2].length) || ((l = a[1]), (t = '/' + a[3])));
        var h,
          f = (n ? n[1] : t).match(/(:[0-9]+)/),
          w = '';
        ...
        try {
          ...
          (x = o),
            l || r || !/^\/\//.test(t) || /^\/\/.+[@.]/.test(t) || ((S = '/'), (t = t.substr(1)));
          try {
            h = new URL(t, s);
          } catch (t) {
        ...
        (_.slashes = c && !S),
          ...
          (_.hostname = h.hostname === u ? '' : h.hostname.replace(/(\[|\])/g, '')),
        ...
        !_.search && ~P[0].indexOf('?') && (_.search = '?'),
          ...
          l && !v.test(l) && '/' !== t.slice(-1) && '/' === _.pathname && (_.pathname = ''),
          (_.path = _.pathname + _.search),
          (_.auth = [h.username, h.password].map(decodeURIComponent).filter(Boolean).join(':')),
          (_.port = h.port),
          w && ((_.host = _.host.replace(w + '00', w)), (_.port = _.port.slice(0, -2))),
          (_.href = S ? '' + _.pathname + _.search + _.hash : i(_));
        var k = /^(file)/.test(_.href) ? ['host', 'hostname'] : [];
        return (
          Object.keys(_).forEach(function (t) {
            ~k.indexOf(t) || (_[t] = _[t] || null);
          }),
          _
        );
      }
        ...
        (e.getRouteRegex = function (t) {
          var e = ((a = t.replace(/\/$/, '') || '/'), a.replace(/[|\\{}()[\]^$+*?.-]/g, '\\$&')),
            ...
            o = e.replace(/\/\\\[([^/]+?)\\\](?=\/|$)/g, function (t, e) {
              ...
              return (
                a && (e = e.slice(6)),
                (r[e.replace(/\\([|\\{}()[\]^$+*?.-])/g, '$1')] = { pos: n++, repeat: a }),
                a ? (o ? '(?:/(.+?))?' : '/(.+?)') : '/([^/]+?)'
              );
            });
          var a;
          0;
          return { re: new RegExp('^' + o + '(?:/)?$', 'i'), groups: r, namedRegex: void 0 };
        });
    },
    dZ6Y: function (t, e, r) {
      'use strict';
      ...
      var _ = (function () {
        function t(e, r, n, o) {
          ...
          i(this, t),
            ...
            (this.pathname = e),
            (this.query = r),
            (this.asPath = (0, f.isDynamicRoute)(e) && __NEXT_DATA__.autoExport ? e : n),
            (this.basePath = d),
            (this.sub = m),
            (this.clc = null),
            (this._wrapApp = p),
              ...
              },
              {
                ...
                value: function (e, r, n, o) {
                  ...
                  return new Promise(function (i, c) {
                    o._h || (a.isSsr = !1), h.ST && performance.mark('routeChange');
                    var u = 'object' === typeof r ? (0, h.formatWithValidation)(r) : r,
                      l = 'object' === typeof n ? (0, h.formatWithValidation)(n) : n;
                    if (
                      ((u = y(u)),
                      (l = y(l)),
                    ...
                    if ((0, f.isDynamicRoute)(_)) {
                      var P = (0, s.parse)(l).pathname,
                        k = (0, v.getRouteRegex)(_),
                        C = (0, p.getRouteMatcher)(k)(P);
                      if (C) Object.assign(b, C);
                      else if (
                        Object.keys(k.groups).filter(function (t) {
                          return !b[t];
                        }).length > 0
                      )
                        return c(
      ...
      t.exports = function (t, e, r, a) {
        ...
        for (var l = 0; l < s; ++l) {
          var h,
            ...
            d = t[l].replace(c, '%20'),
            y = d.indexOf(r);
          y >= 0 ? ((h = d.substr(0, y)), (f = d.substr(y + 1))) : ((h = d), (f = '')),
            (p = decodeURIComponent(h)),
            (v = decodeURIComponent(f)),
            n(i, p) ? (o(i[p]) ? i[p].push(v) : (i[p] = [i[p], v])) : (i[p] = v);
        }
        return i;
      };
      var o =
